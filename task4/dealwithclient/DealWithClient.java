    ...
    public void run() {
        try{
            ...
            if (connection != null){
                ...
                try{
                    connection.close(); // catch exception here.
                }
...
// Then for running it from another file we do:
// Thread dealing = new Thread(new DealWithClient(connection))
// dealing.start();